...
class Bank:
    def __init__(
        ...
        clientes: list[clientes.Person] | None = None,
        contas: list[contas.Account] | None = None,
    ):
    ...
    def _checa_agencia(self, conta):
        if conta.agency in self.agencias:
    ...
    def autenticar(self, cliente: clientes.Person, conta: contas.Account):
